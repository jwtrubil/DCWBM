...
RcppExport SEXP _DCWBM_waterbalance(SEXP calvalsSEXP, SEXP dataSEXP, SEXP outSEXP, SEXP rsnowpartSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_DCWBM_waterbalance", (DL_FUNC) &_DCWBM_waterbalance, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_DCWBM(DllInfo *dll) {
